...
xlabel('Max. energy capacity $|E|$',fontsize=14)
...
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.2,0.45), ncol=2,fancybox=True,shadow=True,fontsize=10)
ylim([0.05,0.43])
# legend(loc='best',fancybox=True)
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
...
plot(x_axis,steady_estate[1],color='green',markerfacecolor='none', markeredgecolor='green', marker='^',markersize=8,label='CAS')
