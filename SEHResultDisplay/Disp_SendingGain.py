...
plot(x_axis,steady_snd_r[0],color='red',markerfacecolor='none', markeredgecolor='red', marker='o',markersize=8,label='MDP (Sending)')
plot(x_axis,steady_snd_r[1],color='green',markerfacecolor='none', markeredgecolor='green', marker='^',markersize=8,label='CAS (Sending)')
plot(x_axis,steady_snd_r[2],color='blue',markerfacecolor='none', markeredgecolor='blue', marker='s',markersize=8,label='GRD (Sending)')
plot(x_axis,steady_snd_r[3],color='black',markerfacecolor='none', markeredgecolor='black', marker='x',markersize=8,label='RND (Sending)', linestyle='')
plot(x_axis,steady_snd_r[4],color='magenta',markerfacecolor='none', markeredgecolor='magenta', marker='d',markersize=8,label='THR (Sending)', linestyle='')
xlabel('Revenue of sending',fontsize=14)
ylabel('Charging rate',fontsize=16)
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.05,0.54), ncol=2,fancybox=True,shadow=True,fontsize=10)
ylim([0.0,0.43])
# legend(loc='best',fancybox=True)
locs, labels = plt.yticks()
